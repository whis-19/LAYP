...
public class LoginSteps {
    ...
    public void user_enters_credentials_from_db() throws Exception {
        String username = DataBaseConnection.getTestData("SELECT username FROM test_cases_data WHERE id=2");
        String password = DataBaseConnection.getTestData("SELECT password FROM test_cases_data WHERE id=2");
